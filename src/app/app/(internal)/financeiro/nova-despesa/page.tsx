...
import { criarDespesa } from "@/lib/actions"
...
export default function NovaDespesaPage() {
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <h1 className="mt-3 font-heading text-2xl font-semibold tracking-tight">Nova despesa</h1>

      <form action={criarDespesa} className="mt-6 space-y-5 rounded-xl border border-border bg-card p-6 shadow-xs">
        <label className="block space-y-1.5">
          <span className={labelCls}>Descrição *</span>
          <input name="descricao" required placeholder="Ex.: Assinatura Figma" className={inputCls} />
        </label>
